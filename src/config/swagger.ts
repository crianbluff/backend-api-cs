      ...
      schemas: {
        ...
        GuestBase: {
          ...
          properties: {
            ...
            visitedDate: {
              ...
              description: 'Raw date string e.g. "November 2025" or "08 June 2026"',
            },
            visitedAt: { type: 'string', format: 'date-time', description: 'Computed Date for sorting/filtering' },
        ...
        GuestListItem: {
          ...
          properties: {
            ...
            nights: { type: 'number' },
            stayed: { type: 'boolean' },
            visitedDate: { type: 'string', example: 'November 2025' },
        ...
        CreateSoloGuestDto: {
          ...
          properties: {
            ...
            comments: { type: 'string', nullable: true },
            didWeHangOut: { type: 'boolean' },
            visitedDate: { type: 'string', example: 'November 2025', description: '"Month Year" or "DD Month Year"' },
            isFirstTime: { type: 'boolean', default: false },
        ...
        CreateCoupleGuestDto: {
          type: 'object',
          required: ['nights', 'stayed', 'didWeHangOut', 'visitedDate', 'wasACouple', 'coupleInfo'],
          properties: {
            nights: { type: 'number', minimum: 1 },
            stayed: { type: 'boolean' },
            didWeHangOut: { type: 'boolean' },
